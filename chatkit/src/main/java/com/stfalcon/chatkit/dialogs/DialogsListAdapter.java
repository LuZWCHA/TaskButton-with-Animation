...
public class DialogsListAdapter<DIALOG extends IDialog>
     ...
     */
    public DialogsListAdapter(ImageLoader imageLoader) throws Exception {
     ...
     * @param imageLoader  image loading method
     */
    public DialogsListAdapter(@LayoutRes int itemLayoutId, ImageLoader imageLoader) throws Exception {
    ...
    public DialogsListAdapter(@LayoutRes int itemLayoutId, Class<? extends BaseDialogViewHolder> holderClass,
                              ImageLoader imageLoader) throws Exception {
        if(!Fresco.hasBeenInitialized())
            throw new Error("Fresco has not been initialized!");
    ...
    * */
    ...
    public static class DialogViewHolder<DIALOG extends IDialog> extends BaseDialogViewHolder<DIALOG> {
        ...
        public DialogViewHolder(View itemView) {
            ...
            ivLastMessageUser = (SimpleDraweeView) itemView.findViewById(R.id.dialogLastMessageUserAvatar);
            ivAvatar = (SimpleDraweeView) itemView.findViewById(R.id.dialogAvatar);
