...
public final class MessagesFixtures extends FixturesData {
    ...
    public static ArrayList<String> getArticleImages(){
        ArrayList<String> images = new ArrayList<>();
        for(int i = 0;i<10;i++){
            images.add(getRandomArticleImage());
        }
        return images;
    }

    public  static ArticleBean getArticles(){
        return ArticleBean.makeArticleBean();
    }

    public static String getArticleImage(){
